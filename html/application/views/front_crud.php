        ...
        <section class="about" id="about">
            <form action="<?=current_url()?>" method="post">
              <div style="display: block; margin: 0 auto; width: fit-content; margin-top: 50px;">
                <select class="btn" name="table">
                  <option <?=($this->input->post("table") == "mythic_plus" ? 'selected' : '')?> value="mythic_plus">Mythic Plus</option>
                  <option <?=($this->input->post("table") == "manual_edits" ? 'selected' : '')?> value="manual_edits">Manual Edits</option>
                  <option <?=($this->input->post("table") == "levelling" ? 'selected' : '')?> value="levelling">Levelling</option>
                  <option <?=($this->input->post("table") == "gtrack" ? 'selected' : '')?> value="gtrack">GTrack</option>
                  <option <?=($this->input->post("table") == "pvp" ? 'selected' : '')?> value="pvp">PvP</option>
                  <option <?=($this->input->post("table") == "raids" ? 'selected' : '')?> value="raids">Raids</option>
                </select>
                ...
                <input type="submit" class="btn" value="View Selected"/>
              </div>
            </form>
